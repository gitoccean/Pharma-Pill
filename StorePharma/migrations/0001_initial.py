# Generated by Django 4.2.7 on 2024-03-05 10:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='about_Pharma',
            fields=[
                ('Pk_about_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ...
                ('about_img', models.ImageField(blank=True, max_length=255, upload_to='Profile/')),
        ...
        migrations.CreateModel(
            name='Blogs_Pharma',
            fields=[
                ('Pk_blog_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ...
                ('blog_img', models.ImageField(blank=True, max_length=255, upload_to='Profile/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            name='db_Medicine',
            fields=[
                ('Medicine_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ...
                ('Med_photo', models.ImageField(blank=True, max_length=255, upload_to='Medicine/')),
        ...
        migrations.CreateModel(
            name='med_Cart_list',
            fields=[
                ('Pk_Cart_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Pk_OrderMedicine_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list1_img', models.ImageField(blank=True, max_length=255, upload_to='MedList/')),
                ('list2_img', models.ImageField(blank=True, max_length=255, upload_to='MedList/')),
                ('list3_img', models.ImageField(blank=True, max_length=255, upload_to='MedList/')),
                ('list4_img', models.ImageField(blank=True, max_length=255, upload_to='MedList/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            name='OptionList',
            fields=[
                ('Option_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Pk_Time_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='med_Order',
            fields=[
                ('Pk_order_ID', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ...
                ('med_order_ID', models.ManyToManyField(default=True, to='StorePharma.db_medicine')),
            ],
        ),
    ]
