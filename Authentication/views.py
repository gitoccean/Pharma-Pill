        ...
        if request.method == 'POST':
            ...
            try:
                ...
                profile_obj = db_Profile.objects.create(db_email=user_obj,
                                                        ...
                                                        db_address=var_address, db_address_Country=var_address_Country,
                                                        db_date_DoB=var_date_DoB
                                                        )
...
def send_mail_after_registration(email, token):
    ...
    # domain = 'http://127.0.0.1:8000/activation/'+str(user.pk)+'/' never use hardcore url address
